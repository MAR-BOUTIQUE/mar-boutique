...
const SOCIAL = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/marboutiquee/",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61588291982862",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@marboutiquee",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
  ...
  {
    label: "Email",
    href: "mailto:hola@mar-boutique.com",
    icon: (
